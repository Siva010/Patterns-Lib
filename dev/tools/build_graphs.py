...
VIZ = {
    ...
    695: ("695-max-area-of-island.html",
          "Interactive visualizer — the DFS returns a value, and the subtotals flowing back up"),
    130: ("130-surrounded-regions.html",
          "Interactive visualizer — seed the border, mark what escapes, flip the complement"),
    1020: ("1020-number-of-enclaves.html",
           "Interactive visualizer — the same machine as 130, counting instead of flipping"),
    417: ("417-pacific-atlantic-water-flow.html",
          "Interactive visualizer — two reverse floods instead of one traversal per cell"),
    ...
    1926: ("1926-nearest-exit-from-entrance-in-maze.html",
           "Interactive visualizer — the entrance sits on the border and is still not an exit"),
    994: ("994-rotting-oranges.html",
          "Interactive visualizer — every source seeded before the first pop, and the fresh counter"),
    542: ("542-01-matrix.html",
          "Interactive visualizer — seed every zero at once, beside the two-pass DP and the one sweep that fails"),
    1162: ("1162-as-far-from-land-as-possible.html",
           "Interactive visualizer — the last level is the answer, and the distance matrix is thrown away"),
    934: ("934-shortest-bridge.html",
          "Interactive visualizer — a DFS to discover the sources, then multi-source BFS from all of them"),
